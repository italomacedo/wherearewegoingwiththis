...
export const STRINGS: Record<string, Entry> = {
  ...
  'editor.doorSpawnAuto': e('Spawn: auto (in front of door)', 'Spawn: automático (em frente à porta)'),
  ...
  'editor.region.head': e('head', 'cabeça'),
  'editor.region.top': e('top', 'cima'),
  'editor.region.bottom': e('bottom', 'baixo'),
  ...
  'hud.enterDoor': e('[F] Enter', '[F] Entrar'),
  'hud.exitDoor': e('[F] Exit', '[F] Sair'),
  'hud.homeDoor': e('[F] Exit    [E] Furniture', '[F] Sair    [E] Mobília'),
  'hud.openStorage': e('[E] Open {name}', '[E] Abrir {name}'),
  'hud.pickUp': e('[E] Pick up {name}', '[E] Pegar {name}'),
  'hud.sleep': e('[E] Sleep', '[E] Dormir'),
  'hud.sleepRested': e('Already rested (24h)', 'Já descansou (24h)'),
  ...
  // ─── Sleep (beds) ────────────────────────────────────────────────────────
  'sleep.title': e('SLEEPING…', 'DORMINDO…'),
  'sleep.cooldown': e('You can only sleep once per 24h.', 'Você só pode dormir uma vez a cada 24h.'),
  'sleep.wellRestedGained': e('Well Rested — 2× gains (2h)', 'Bem Descansado — 2× ganhos (2h)'),
  ...
  // ─── Housing (furniture shop + placement + cabinet storage) ───────────────
  'housing.prompt': e('Furniture', 'Mobília'),
  'housing.title': e('FURNITURE', 'MOBÍLIA'),
  'housing.shop': e('SHOP', 'LOJA'),
  'housing.buy': e('Buy', 'Comprar'),
  'housing.sell': e('Sell', 'Vender'),
  'housing.done': e('DONE', 'CONCLUIR'),
  'housing.move': e('Move', 'Mover'),
  'housing.rotate': e('Rotate', 'Girar'),
  'housing.scale': e('Scale', 'Escalar'),
  'housing.credits': e('Credits: {n}', 'Créditos: {n}'),
  'housing.cantAfford': e("You can't afford that.", 'Você não tem créditos para isso.'),
  'housing.bought': e('Bought {name} (−{n} cr)', 'Comprou {name} (−{n} cr)'),
  'housing.sold': e('Sold {name} (+{n} cr)', 'Vendeu {name} (+{n} cr)'),
  'housing.hint': e('Click to select · 1/2/3 move/rotate/scale · Camera: drag mid/right or WASD·Z/C·R/F·wheel · DONE',
    'Clique p/ selecionar · 1/2/3 mover/girar/escalar · Câmera: arrastar meio/dir ou WASD·Z/C·R/F·roda · CONCLUIR'),
  'housing.selectFirst': e('Select a piece first.', 'Selecione uma mobília primeiro.'),
  'housing.storageTitle': e('{name}', '{name}'),
  'housing.deposit': e('Store', 'Guardar'),
  'housing.withdraw': e('Take', 'Pegar'),
  'housing.pack': e('Pack', 'Mochila'),
  'housing.cabinet': e('Cabinet', 'Armário'),
  'housing.yourPack': e('Your pack', 'Sua mochila'),
  'housing.inCabinet': e('In cabinet', 'No armário'),
  // Furniture names
  'furniture.kitchen_cabinet1': e('Kitchen Cabinet', 'Armário de Cozinha'),
  'furniture.kitchen_cabinet2': e('Kitchen Cabinet II', 'Armário de Cozinha II'),
  'furniture.kitchen_cabinetsmall': e('Small Cabinet', 'Armário Pequeno'),
  'furniture.drawer_1': e('Dresser', 'Cômoda'),
  'furniture.drawer_2': e('Tall Dresser', 'Cômoda Alta'),
  'furniture.nightstand_1': e('Nightstand', 'Criado-mudo'),
  'furniture.nightstand_2': e('Nightstand II', 'Criado-mudo II'),
  'furniture.bookshelf': e('Bookshelf', 'Estante'),
  'furniture.shelf_large': e('Large Shelf', 'Prateleira Grande'),
  'furniture.kitchen_fridge': e('Fridge', 'Geladeira'),
  'furniture.bed_single': e('Single Bed', 'Cama de Solteiro'),
  'furniture.bed_king': e('King Bed', 'Cama de Casal'),
  'furniture.couch_small1': e('Small Couch', 'Sofá Pequeno'),
  'furniture.couch_medium1': e('Couch', 'Sofá'),
  'furniture.couch_large1': e('Large Couch', 'Sofá Grande'),
  'furniture.chair_1': e('Chair', 'Cadeira'),
  'furniture.chair_2': e('Chair II', 'Cadeira II'),
  'furniture.stool': e('Stool', 'Banco'),
  'furniture.table_roundsmall': e('Small Table', 'Mesa Pequena'),
  'furniture.table_roundlarge': e('Round Table', 'Mesa Redonda'),
  'furniture.houseplant_1': e('Houseplant', 'Planta'),
  'furniture.houseplant_3': e('Houseplant II', 'Planta II'),
  'furniture.carpet_1': e('Rug', 'Tapete'),
  'furniture.carpet_round': e('Round Rug', 'Tapete Redondo'),
  'furniture.light_floor1': e('Floor Lamp', 'Luminária de Chão'),
  'furniture.light_stand1': e('Standing Lamp', 'Abajur de Pé'),
  'furniture.fireplace': e('Fireplace', 'Lareira'),
  ...
  'creator.colors': e('Colors', 'Cores'),
  'creator.appearance': e('Appearance', 'Aparência'),
  'creator.build': e('Build', 'Atributos'),
  'creator.keepOriginal': e('Original', 'Original'),
  'creator.tabAttributes': e('Attributes', 'Atributos'),
  'creator.tabSkills': e('Skills', 'Perícias'),
  'creator.tabPerks': e('Perks', 'Vantagens'),
  'creator.jumpsuitBottom': e('— included in the jumpsuit', '— incluído no macacão'),
