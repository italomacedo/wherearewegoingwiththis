...
export const STRINGS: Record<string, Entry> = {
  ...
  'combat.advance': e('Advance 1m', 'Avançar 1m'),
  'combat.retreat': e('Back 1m', 'Recuar 1m'),
  ...
  'combat.logHit': e('{a} hits {b} — roll {roll} < {chance}% — {dmg} dmg', '{a} acerta {b} — rolagem {roll} < {chance}% — {dmg} de dano'),
  'combat.logKill': e('{a} drops {b} — roll {roll} < {chance}% — {dmg} dmg', '{a} derruba {b} — rolagem {roll} < {chance}% — {dmg} de dano'),
  'combat.logMiss': e('{a} misses {b} — roll {roll} ≥ {chance}%', '{a} erra {b} — rolagem {roll} ≥ {chance}%'),
